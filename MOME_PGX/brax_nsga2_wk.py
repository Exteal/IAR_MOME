...
from run_nsga2 import RunNSGA2
...
from qdax.utils.metrics import CSVLogger, default_moqd_metrics, default_ga_metrics
...
class ExperimentConfig:
    ...
    population_size: int #=PF size x num centroids
    batch_size: int 
    num_evaluations: int
    num_init_cvt_samples: int
    num_centroids: int
...
@hydra.main(config_path="configs/brax/walker", config_name="brax_nsga2")
def main(config: ExperimentConfig) -> None:
    ...
    nsga2 = RunNSGA2(
        ...
        ga_metrics_fn=default_ga_metrics,
        num_objective_functions=config.num_objective_functions,
